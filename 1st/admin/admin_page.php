...
<body>
    ...
    <header class="top-bar">
        <div class="logo">Mura</div>
        <nav>
            <button data-section="photos">Фото</button>
            <button data-section="videos">Видео</button>
            <button data-section="docs">Документы</button>
        </nav>
        <div>
    ...
    <div class="btn-container ">
        ...
        <label class="switch btn-color-mode-switch">
            <input class="focus-btn" value="1" id="color_mode" name="color_mode" type="checkbox">
